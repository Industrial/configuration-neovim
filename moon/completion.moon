...
languageServerProtocol = (use) ->
  ...
  use {
    ...
    config: () ->
      ...
      -- npm i -g eslint_d @cucumber/language-server bash-language-server dot-language-server dot-language-server graphql-language-service-cli stylelint-lsp typescript-language-server typescript eslint eslint_d vim-language-server vscode-langservers-extracted yaml-language-server cssmodules-language-server @johnnymorganz/stylua-bin
